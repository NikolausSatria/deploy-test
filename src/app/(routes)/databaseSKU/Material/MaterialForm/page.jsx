        ...
        <div className="flex h-full p-5 flex-col bg-white text-left font-sans font-medium shadow-md">
          ...
          <div className="px-3 flex space-x-5">
            ...
            <div className="mb-5 w-1/2">
              ...
              <input
                ...
                onChange={e=>setState({...state, material_id: e.target.value})} 
                required
              />
            </div>
            {/* Material Type*/}
            <div className="mb-5 w-1/2">
              ...
              <input
                ...
                onChange={e=>setState({...state, material_type: e.target.value})} 
                required
              />
            </div>
          </div>
          ...
          <div className="px-3 mb-5 w-full">
            ...
            <input
              ...
              onChange={e=>setState({...state, material_description: e.target.value})} 
              required
            />
          </div>
          ...
          <div className="px-3 flex space-x-5">
            ...
            <div className="mb-5 w-1/2">
              ...
              <input
                ...
                onChange={e=>setState({...state, minimum_stock: e.target.value})} 
                required
              />
            </div>
            {/* ROP */}
