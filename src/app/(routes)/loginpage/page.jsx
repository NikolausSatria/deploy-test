...
<div className="-my-2 py-2 sm:-mx-6 sm:px-6 lg:-mx-8 pr-10 lg:px-8">
                <div className=" rounded-tl-lg rounded-tr-lg inline-block w-full py-4 overflow-hidden bg-white shadow-lg px-10">
                    <div className="flex justify-between">
                        <div className="inline-flex border rounded w-7/12 px-2 lg:px-6 h-12 bg-transparent">
                            <div className="flex flex-wrap items-stretch w-full h-full mb-6 relative">
                                ...
                                <input type="text" class="flex-shrink flex-grow flex-auto leading-normal tracking-wide w-px border border-none border-l-0 rounded rounded-l-none px-3 relative focus:outline-none text-xxs  lg:text-base text-gray-500 font-thin" placeholder="Search"></input>
                            </div>
                        </div>
                    </div>
                </div>

                {/*this is the container of table List */}
                <div className="relative left-[20%] top-[120px] inline-block min-w-[800px] shadow overflow-hidden bg-white shadow-dashboard px-4 pt-3 rounded-bl-lg rounded-br-lg">
                        ...
                        <tbody className="bg-white">
                                    <tr>
                                        ...
                                        <td className="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">
                                            ...
                                            <span classNameName="relative text-xs">active</span>
                                        </span>
                                        </td>
